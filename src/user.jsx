      ...
      return (
        <div className='bground'> {/*User is logged in, either redirect to profile or log out*/}
          ...
          <div className='centre'>
            ...
            <div className='box'>
      			     <Link to={"../User"}> <button className='btn w-100 my-2 my-sm-0 mr-1' type='button' onSubmit={UserProfile.setName("Login")} >Log Out</button></Link> {/*Link doesnt work, change to reload page*/}
            </div>
          </div>
        </div>
      )
